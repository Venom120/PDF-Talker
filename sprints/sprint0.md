Nice — you want a concrete, actionable sprint plan you can follow start-to-finish. I’ll be blunt: this project is *doable*, but not trivial — the hard parts are real-time audio streaming, robust RAG (making the model reliably cite PDF text), and the 3D avatar + believable lip-sync. I split everything into clear sprints (no time estimates — you asked for Agile sprints, not promises). Follow the checklist & code snippets below and you’ll have a repeatable plan for the hackathon.
...
* generate a ready-to-copy `README.md` and `issue` templates for Sprint 0, **and**
* produce the Lambda `presign_upload` and `s3_ingest_trigger` starter code (Python), **and**
* outline the exact `cloudformation` / `serverless.yml` resources to paste into the AWS “Search and select resources (manual)” page.

Pick one of the three and I’ll produce it straight away (no waiting). Which starter artifact do you want now?

[1]: https://aws.amazon.com/ai/generative-ai/nova/speech/?utm_source=chatgpt.com "Speech-to-Speech Model - Amazon Nova Sonic"
[2]: https://docs.aws.amazon.com/kendra/latest/dg/tutorial-search-metadata-create-index-ingest.html?utm_source=chatgpt.com "Step 4: Creating an Amazon Kendra index and ingesting the metadata"
[3]: https://docs.aws.amazon.com/opensearch-service/latest/developerguide/vector-search.html?utm_source=chatgpt.com "Vector search - Amazon OpenSearch Service"
[4]: https://docs.aws.amazon.com/bedrock/latest/userguide/getting-started-api-ex-cli.html?utm_source=chatgpt.com "Run example Amazon Bedrock API requests with the AWS ..."
[5]: https://docs.aws.amazon.com/transcribe/latest/dg/getting-started-http-websocket.html?utm_source=chatgpt.com "Transcribing with HTTP or WebSockets"
[6]: https://docs.aws.amazon.com/polly/latest/dg/synthesize-example.html?utm_source=chatgpt.com "Synthesizing speech with Amazon Polly example"
[7]: https://github.com/aws-samples/amazon-transcribe-websocket?utm_source=chatgpt.com "aws-samples/amazon-transcribe-websocket"
[8]: https://docs.aws.amazon.com/nova/latest/userguide/speech.html?utm_source=chatgpt.com "Using the Amazon Nova Sonic Speech-to-Speech model"
[9]: https://docs.aws.amazon.com/bedrock/latest/userguide/inference-invoke.html?utm_source=chatgpt.com "Submit a single prompt with InvokeModel - Amazon Bedrock"
